...
import { defaultFile, defaultFolder, definitions, getFileIconName } from '../src/lib/file-icons.ts'
import { hasIcon, iconAssetUrls, iconifySvg } from '../src/lib/iconify.ts'
...
test('directory code trees resolve relative paths and omit binary source panels', async () => {
  const sourcePath = path.resolve('tests/fixtures/page.md')
...
test('directory code trees reject paths outside the project', async () => {
  await assert.rejects(
    renderMarkdown('@[code-tree](../../../../)', { sourcePath: path.resolve('tests/fixtures/page.md') }),
...
test('Markdown power settings override env presets and can disable abbreviation and annotation syntax', async () => {
  ...
  try {
    ...
    const configuredUrl = new URL('../src/lib/markdown.ts', import.meta.url)
...
[+preset]: Local annotation`)
    ...
    const disabledUrl = new URL('../src/lib/markdown.ts', import.meta.url)
...
test('Obsidian callouts keep the frozen alias, locale, and custom renderer matrices', async () => {
  ...
  try {
    ...
    const localeUrl = new URL('../src/lib/markdown.ts', import.meta.url)
    ...
    const callbackUrl = new URL('../src/lib/markdown.ts', import.meta.url)
