...
import { collectionForEntry, collectionsFor, defineCollection, defineCollections, defineNavbarConfig, defineThemeConfig } from '../src/lib/collections.ts'
import { resolveSidebar, sidebarGroups } from '../src/lib/sidebar.ts'
